<footer class="mt-[80px] sm:mt-[120px] w-full px-4 sm:px-5 pt-10 pb-10 bg-navDark rounded-[20px]">
    <div class="max-w-7xl mx-auto flex flex-col items-center gap-6 md:gap-8">
        ...
        <div class="flex items-center justify-center gap-4" aria-label="Redes sociales">
            <a href="https://www.facebook.com/profile.php?id=61579364399371" target="_blank" rel="noopener noreferrer" class="text-caribeOrange hover:text-[#faf8f3] transition-colors p-2 rounded-[12px] hover:bg-white/10" aria-label="Facebook - Daphne Breeze">
                <svg class="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
            </a>
            <a href="https://www.instagram.com/hotel_daphnebreeze" target="_blank" rel="noopener noreferrer" class="text-caribeOrange hover:text-[#faf8f3] transition-colors p-2 rounded-[12px] hover:bg-white/10" aria-label="Instagram - Hotel Daphne Breeze">
                <svg class="w-6 h-6 md:w-7 md:h-7" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div class="flex flex-col items-center gap-1 text-center text-xs md:text-sm text-caribeOrange/80 px-4">
            <div class="flex flex-wrap justify-center gap-x-4 gap-y-1">
                <a href="{{ route('privacy') }}" class="hover:text-[#faf8f3] transition-colors">Política de privacidad</a>
                <span class="hidden sm:inline" aria-hidden="true">·</span>
                <a href="{{ route('terms') }}" class="hover:text-[#faf8f3] transition-colors">Términos y condiciones</a>
            </div>
            <p>
