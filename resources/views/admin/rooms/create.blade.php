...
@section('content')
    <div class="mt-[80px] sm:mt-[120px]">
        <div class="mb-8 md:mb-10 flex items-center justify-between">
            <div>
                <h1 class="text-navDark text-2xl md:text-3xl font-bold">Crear Habitación</h1>
                <p class="mt-1 text-navDark/70 italic text-sm md:text-base">Agregar una nueva habitación</p>
            </div>
