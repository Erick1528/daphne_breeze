...
@section('content')
    <div class="mt-[80px] sm:mt-[120px]">
        <div class="mb-8 md:mb-10 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <div>
                <h1 class="text-navDark text-2xl md:text-3xl font-bold">Ofertas</h1>
                <p class="mt-1 text-navDark/70 italic text-sm md:text-base">Gestionar ofertas y promociones del hotel</p>
            </div>
